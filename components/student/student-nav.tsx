...
import { Home, BookOpen, Trophy, Calendar, FileText, Monitor, LogOut, Wifi, WifiOff, RefreshCw } from "lucide-react"
...
export function StudentNav({ activeTab, onTabChange }: StudentNavProps) {
  ...
  const navItems = [
    ...
    { id: "lessons", label: t("myLessons"), icon: BookOpen },
    { id: "progress", label: t("progress"), icon: Trophy },
